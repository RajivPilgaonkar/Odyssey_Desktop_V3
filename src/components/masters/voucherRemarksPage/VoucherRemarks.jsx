...
import { getDevExtremeTable, getDevExtremePopupForm, tableHeaderArray } from "./GetVoucherRemarksData";
...
function VoucherRemarks() {
  ...
  useEffect (() => {
    ...
    compVar = {
      ...
      masterDescField: 'VoucherRemarks',
  ...
  const fetchInitialData = async() => {
    try {
      ...
      compVar.userLookup = await dbGetRecord({fields: ['AdmUsers_id', 'uid'], orders: ['uid'], table: 'admUsers', x_uid: _g_users_id, x_module: 'Voucher Remarks'});   
  ...
  const filterData = async() => {
    ...
    try {
      compVar.mainData =  await dbGetRecord({fields: fieldArray, orders: ['VoucherRemarks'], table: 'VoucherRemarks'});   
    } catch(err) {
      alert(err);
    }
