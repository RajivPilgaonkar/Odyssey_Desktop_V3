...
import { getDevExtremeTable, getDevExtremePopupForm, tableHeaderArray } from "./GetNetworkDetailsData";
...
function NetworkDetails(props) {
  ...
  useEffect (() => {
    ...
    compVar = {
      ...
      agentLookup: [],
      clonedMainData: [],
      tableName: 'PrincipalAgentNetworkDetails', keyField: 'PrincipalAgentNetworkDetails_id',
      masterDescField: '',
      formData: [], formOldData: [], formMode: -1, formTitle: 'ABC',
      mainTitle: 'Principal Agents', title: 'New Principal Agent',
  ...
  const filterData = async() => {
    ...
    let whereStr = 'PricipalAgentNetworks_id = ' + props.networksId.toString();
    try {
      compVar.mainData =  await dbGetRecord({fields: fieldArray, orders: ['PrincipalAgentNetworkDetails_id'], table: 'PrincipalAgentNetworkDetails', where: whereStr, x_uid: _g_users_id, x_module: 'Principal Agent Networks'});   
  ...
  const addRow = async () => {
    ...
    defaultObj = {...defaultObj, 
      PricipalAgentNetworks_id: props.networksId
    }
  ...
  const saveFormData = async () => {
    ...
    let condition = "WHERE Addressbook_id = " + compVar.formData.Addressbook_id.toString() + " AND " + 
      "PricipalAgentNetworks_id = " + compVar.formData.PricipalAgentNetworks_id.toString();
