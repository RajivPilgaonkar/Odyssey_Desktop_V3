...
import ElementsCarHireDetails from './elementsCarHireDetailsPage/ElementsCarHireDetails';

export const tableHeaderArray = 
[ 
  {key: 1, label: "ID", field: 'ElemCars_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
  ...
  {key: 7, label: "From City", field: 'FromCities_id', width: 80, align: "left", dataType: 'number', visible: false, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 1, required: true},        
  {key: 8, label: "To City", field: 'ToCities_id', width: 80, align: "left", dataType: 'number', visible: false, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 1, required: true},        
  {key: 9, label: "Service City", field: 'ServiceCities_id', width: 80, align: "left", dataType: 'number', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, colSpan: 1},        
  {key: 500, label: "EmptyItem500", field: 'EmptyItem', width: 0, align: "left", dataType: 'emptyItem', visible: false, visibleInForm: true, isLookup: false, groupNo: 0, required: false},    

  {key: 4, label: "Sector", field: 'Sector', width: 140, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, editorOptions: {maxLength: 30, readOnly: true}, allowFilter: true},    
  {key: 5, label: "Code", field: 'QuotationRef', width: 70, align: "center", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 1, editorOptions: {maxLength: 30, readOnly: true}, allowFilter: true, allowSort: true},    
  {key: 6, label: "Module", field: 'PaxName', width: 250, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, editorOptions: {maxLength: 30, readOnly: true}, allowFilter: true},    
  {key: 501, label: "EmptyItem501", field: 'EmptyItem', width: 0, align: "left", dataType: 'emptyItem', visible: false, visibleInForm: true, isLookup: false, groupNo: 0, required: false},    

  {key: 11, label: "Agent", field: 'Addressbook_id', width: 150, align: "left", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, colSpan: 2, required: true},        
  ...
  {key: 21, label: "Currency", field: 'Currencies_id', width: 80, align: "center", dataType: 'number', visible: true, visibleInForm: true, isLookup: true, groupNo: 0, required: true, default: 27},    
  {key: 24, label: "Quoted", field: 'Quoted', width: 100, align: "center", dataType: 'boolean', visible: false, visibleInForm: false, isLookup: false, groupNo: 0, booleanText: ['Yes','No'], required: true, default: true},
  {key: 503, label: "EmptyItem", field: 'EmptyItem', width: 0, align: "left", dataType: 'emptyItem', visible: false, visibleInForm: true, isLookup: false, groupNo: 0, required: false, colSpan: 2},
      ...
      <div className="master-detail-body-type1">
        ...
        <div style={{flex: 1, justifyContent: 'center'}}>
          <div style={{display: 'flex', flexDirection: 'column', paddingLeft: 10}}>
            <div style={{flex: 1}}>
              {formObj.formMode === 2 && 
                <ElementsCarHireDetails 
                  elements_id={formObj.formData.ElemCars_id}
