...
import { getDevExtremeTable, tableHeaderArray, getDevExtremePopupForm } from "./GetElementsCarHireDetailsData";
...
function ElementsCarHireDetails(props) {
  ...
  useEffect (() => {
    ...
    compVar = {
      mainData: [], userLookup: [],
      vehicleLookup: [], 
      tableName: 'ElemCarsCosts', keyField: 'ElemCarsCosts_id',
      masterDescField: '',
  ...
  const filterData = async() => {
    ...
    try {
      ...
      const whereStr = "(ElemCars_id = " + props.elements_id + ") ";
  ...
  const saveFormData = async () => {
    ...
    condition += (compVar.formMode === 2) ? "AND ElemCarsCosts_id <> " + compVar.formData.ElemCarsCosts_id : "";
...
export default ElementsCarHireDetails;
