...
import { getDevExtremeTable, tableHeaderArray, getDevExtremePopupForm } from "./GetElementsCarExtraDayDetailsData";
...
function ElementsCarExtraDayDetails(props) {
  ...
  useEffect (() => {
    ...
    compVar = {
      mainData: [], userLookup: [],
      vehicleLookup: [], 
      tableName: 'ElemExtraDayCarHireCosts', keyField: 'ElemExtraDayCarHireCosts_id',
      masterDescField: '',
  ...
  const fetchInitialData = async() => {
    ...
    try {
      ...
      let whereStr = "vehicles_id IN " + 
        "(SELECT vehicles_id FROM carhire ch " + 
  ...
  const filterData = async() => {
    ...
    try {
      ...
      const whereStr = "(ElemExtraDayCarHire_id = " + props.elements_id + ") ";
  ...
  const addRow = async () => {
    ...
    defaultObj = {...defaultObj, 
      ElemExtraDayCarHire_id: props.elements_id
    }
  ...
  const saveFormData = async () => {
    ...
    condition += (compVar.formMode === 2) ? "AND ElemExtraDayCarHireCosts_id <> " + compVar.formData.ElemExtraDayCarHireCosts_id : "";
...
export default ElementsCarExtraDayDetails;
