...
import { getDevExtremeTable, tableHeaderArray, getDevExtremePopupForm } from "./GetElementsSightseeingData";
...
function ElementsSightseeing(props) {
  ...
  const fetchInitialData = async() => {
    ...
    try {
      ...
      let whereStr = 'cities_id IN (SELECT s.cities_id FROM services s WHERE s.transfer = 0)';
...
export default ElementsSightseeing;
