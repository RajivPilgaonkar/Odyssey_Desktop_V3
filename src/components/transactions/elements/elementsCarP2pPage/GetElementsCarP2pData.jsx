...
import ElementsCarP2pDetails from './elementsCarP2pDetailsPage/ElementsCarP2pDetails';

export const tableHeaderArray = 
[ 
  {key: 1, label: "ID", field: 'ElemInterCities_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
      ...
      <div className="master-detail-body-type1">
        ...
        <div style={{flex: 1, justifyContent: 'center'}}>
          <div style={{display: 'flex', flexDirection: 'column', paddingLeft: 10}}>
            <div style={{flex: 1}}>
              {formObj.formMode === 2 && 
                <ElementsCarP2pDetails 
                  elements_id={formObj.formData.ElemInterCities_id}
