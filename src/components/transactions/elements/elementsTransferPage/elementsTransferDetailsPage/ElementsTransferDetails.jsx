...
import { getDevExtremeTable, tableHeaderArray, getDevExtremePopupForm } from "./GetElementsTransferDetailsData";
...
function ElementsTransferDetails(props) {
  ...
  useEffect (() => {
    ...
    compVar = {
      ...
      mainTitle: 'Transfer Costs', title: 'New Transfer Cost',
...
export default ElementsTransferDetails;
