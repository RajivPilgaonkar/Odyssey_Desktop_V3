...
import ElementsCarCityGroupsDetails from './elementsCarCityGroupsDetailsPage/ElementsCarCityGroupsDetails';

export const tableHeaderArray = 
[ 
  {key: 1, label: "ID", field: 'ElemCityGroups_id', width: 60, align: "left", dataType: 'number', visible: true, visibleInForm: false, isLookup: false, groupNo: 0},
  ...
  {key: 7, label: "From City", field: 'FromCities_id', width: 80, align: "left", dataType: 'number', visible: false, visibleInForm: false, isLookup: true, groupNo: 0, colSpan: 1, required: true},        
  {key: 8, label: "To City", field: 'ToCities_id', width: 80, align: "left", dataType: 'number', visible: false, visibleInForm: false, isLookup: true, groupNo: 0, colSpan: 1, required: true},        

  {key: 4, label: "Car Hire Group", field: 'CarHireGroup', width: 350, align: "left", dataType: 'string', visible: true, visibleInForm: true, isLookup: false, groupNo: 0, colSpan: 2, editorOptions: {maxLength: 30, readOnly: true}, allowFilter: true},    
      ...
      <div className="master-detail-body-type1">
        ...
        <div style={{flex: 1, justifyContent: 'center'}}>
          <div style={{display: 'flex', flexDirection: 'column', paddingLeft: 10}}>
            <div style={{flex: 1}}>
              {formObj.formMode === 2 && 
                <ElementsCarCityGroupsDetails 
                  elements_id={formObj.formData.ElemCityGroups_id}
