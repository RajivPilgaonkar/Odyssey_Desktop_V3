...
//**********************************************************/
export async function exportVoucherListingReport(mainData, worksheet) {
  
  const columnWidths = [{col: 'A', colIndex: 0, width: 12}, {col: 'B', colIndex: 1, width: 15},
    {col: 'C', colIndex: 2, width: 10}, {col: 'D', colIndex: 3, width: 35}, {col: 'E', colIndex: 4, width: 15},
    {col: 'F', colIndex: 5, width: 20}, {col: 'G', colIndex: 6, width: 15}, {col: 'H', colIndex: 7, width: 15}];
...
async function reportBody(mainData, worksheet) {
  ...
  const fields = [
    ...
    {id: 'TourRef', col: 'C', row: 1, caption: 'Tour Ref', alignment: 'center', field: '', bold: true},
    {id: 'Description', col: 'D', row: 1, caption: 'Description', alignment: '', field: '', bold: true},
    {id: 'TourLeader', col: 'E', row: 1, caption: 'Tour Leader', alignment: '', field: '', bold: true},
    {id: 'Organisation', col: 'F', row: 1, caption: 'Organisation', alignment: '', field: '', bold: true},
    {id: 'Phone', col: 'G', row: 1, caption: 'Phone', alignment: '', field: '', bold: true},
    {id: 'Mobile', col: 'H', row: 1, caption: 'Mobile', alignment: '', field: '', bold: true},
  ];
  ...
  const columns = [
    ...
    {id: 'TourRef', col: 'C', title: '', alignment: 'center', field: 'TourRef'},
    {id: 'Description', col: 'D', title: '', alignment: '', field: 'Description'},
    {id: 'TourLeader', col: 'E', title: '', alignment: '', field: 'TourLeader'},
    {id: 'Organisation', col: 'F', title: '', alignment: '', field: 'Organisation'},
    {id: 'Phone', col: 'G', title: '', alignment: '', field: 'phone'},
    {id: 'Mobile', col: 'H', row: 1, caption: '', alignment: '', field: 'org_mobile'},
  ];
