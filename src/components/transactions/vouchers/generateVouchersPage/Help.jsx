...
<p style={{display: 'inline-block'}}><strong>Broad Steps to Generate Vouchers: </strong> 
<br/>1. Select services for Voucher Creation (Click on 'Tick' button icon OR Options -&gt; Voucher Selection)<br/>
2. Generate Vouchers (Based on Presto Data) <br/>
3. Check Voucher Listing (Click on 'Document' button icon OR  Options -&gt; Voucher Listing)<br/>
4. Check Reports from the Voucher Listing Page <br/>
5. Mail Vouchers to Hotels/Agents (Click on 'Mail' button icon OR  Options -&gt; Email Vouchers)<br/>
</p><br></br>
