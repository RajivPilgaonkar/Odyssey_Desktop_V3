...
async function officeHeader(invData, worksheet) {
  ...
  const fields = [
    ...
    {id: 'placeSupply', col: 'E', row: 5, caption: 'Place Of Supply: ', alignment: '', field: 'PlaceOfSupply'},
    ...
    {id: 'invNo', col: 'B', row: 17, caption: '', alignment: '', field: 'invoiceno'},
...
async function officeSummaryDetails(worksheet) {
  ...
  const columns = [
    ...
    {id: 'invNo', col: 'B', row: 18, caption: '', alignment: 'center', field: 'InvoiceNo',combination: ['YearRef','InvoiceNo']},
...
async function clientPaymentInstructions2(worksheet, invData) {
  ...
  cell.value = 'Payment Instructions:';  
