...
async function clientHeader(invData, worksheet) {
  ...
  const fields = [
    ...
    {id: 'netPrice', col: 'D', row: 22, caption: 'Net Price', alignment: 'right', field: '', bold: true},
    {id: 'qty', col: 'E', row: 22, caption: 'Qty', alignment: 'right', field: '', bold: true},
    {id: 'amount', col: 'F', row: 22, caption: 'Amount', alignment: 'right', field: '', bold: true},
    {id: 'cancel', col: 'G', row: 22, caption: 'Cancel(%)', alignment: 'right', field: '', bold: true},
...
async function clientSummaryDetails(worksheet) {
  ...
  const columns = [
    ...
    {id: 'total', col: 'H', row: 18, caption: 'Total', alignment: 'right', field: 'InvoiceAmount', numformat: '#,##0.00'},
  ];
