...
export async function exportVoucherTallyReport(mainData, worksheet) {
  ...
  const columnWidths = [{col: 'A', colIndex: 0, width: 12}, {col: 'B', colIndex: 1, width: 15},
    ...
    {col: 'F', colIndex: 5, width: 20}, {col: 'G', colIndex: 6, width: 20}, {col: 'H', colIndex: 7, width: 15},
...
async function reportBody(mainData, worksheet) {
  ...
  const columns = [
    ...
    {id: 'TourCode', col: 'H', title: '', alignment: 'center', field: 'TourCode'},
    {id: 'TourDate', col: 'I', title: '', alignment: 'center', field: 'TourDate', dateformat: 'DD/MM/YYYY'},
  ];
