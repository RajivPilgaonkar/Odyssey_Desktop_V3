...
//**********************************************************/
export async function exportOfficeReport(reportObj, invData, worksheet) {
  ...
  for (let i=0; i<invData.length; i++) {
    ...
    await officeHeader(invData[i], worksheet);
    await officePaxNames(invData[i], worksheet);
    await officeDetails(invData[i], worksheet);
  ...
  await officeSummaryHeader(worksheet);
  await officeSummaryDetails(worksheet);
  //await officePaymentInstructions(worksheet);
  await clientPaymentInstructions2(worksheet, invData);

}

//**********************************************************/
async function officeHeader(invData, worksheet) {
...
//**********************************************************/
async function officePaxNames(invData, worksheet) {
...
//**********************************************************/
async function officeDetails(invData, worksheet) {
...
//**********************************************************/
async function officeSummaryHeader(worksheet) {
  ...
  const fields = [
    ...
    {id: 'gst', col: 'I', row: 19, caption: 'GST', alignment: 'right', field: '', bold: true},
    {id: 'i_gst', col: 'J', row: 19, caption: 'I_GST', alignment: 'right', field: '', bold: true},
    {id: 'c_gst', col: 'K', row: 19, caption: 'C_GST', alignment: 'right', field: '', bold: true},
    {id: 's_gst', col: 'L', row: 19, caption: 'S_GST', alignment: 'right', field: '', bold: true},
  ...
  // set Lower Border
  const cellsForBorder = ['A','B','C','D','E','F','G','H','I','J','K','L'];
  const rowBorder = fields[fields.length-1].row+rowNum;
  for (let i=0; i<cellsForBorder.length; i++) {
    const cell = worksheet.getCell(cellsForBorder[i] + rowBorder.toString());
    cell.border = {bottom: {style: 'thin'}, top: {style: 'thin'} };      
...
//**********************************************************/
async function officeSummaryDetails(worksheet) {
  ...
  const columns = [
    ...
    {id: 'total', col: 'H', row: 19, caption: '', alignment: 'right', field: 'InvoiceAmount', numformat: '#,##0.00'},
    {id: 'gst', col: 'I', row: 19, caption: '', alignment: 'right', field: 'TaxAmount', numformat: '#,##0.00'},
    {id: 'i_gst', col: 'J', row: 19, caption: '', alignment: 'right', field: 'I_GST', numformat: '#,##0.00'},
    {id: 'c_gst', col: 'K', row: 19, caption: '', alignment: 'right', field: 'C_GST', numformat: '#,##0.00'},
    {id: 's_gst', col: 'L', row: 19, caption: '', alignment: 'right', field: 'S_GST', numformat: '#,##0.00'},
  ];
...
//**********************************************************/
/*
async function officePaymentInstructions(worksheet) {
