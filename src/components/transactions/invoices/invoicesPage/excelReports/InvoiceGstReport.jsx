...
//**********************************************************/
export async function exportInvoiceGstReport(mainData, worksheet) {
  
  const columnWidths = [{col: 'A', colIndex: 0, width: 12}, {col: 'B', colIndex: 1, width: 15},
    {col: 'C', colIndex: 2, width: 30},
    {col: 'D', colIndex: 3, width: 15}, {col: 'E', colIndex: 4, width: 12}, {col: 'F', colIndex: 5, width: 15},
    {col: 'G', colIndex: 6, width: 12}, {col: 'H', colIndex: 7, width: 20}, {col: 'I', colIndex: 8, width: 12},
    {col: 'J', colIndex: 9, width: 12}, {col: 'K', colIndex: 10, width: 12}, {col: 'L', colIndex: 11, width: 12}];
...
async function reportBody(mainData, worksheet) {
  ...
  const fields = [
    ...
    {id: 'Organisation', col: 'C', row: 1, caption: 'Customer', alignment: 'left', field: '', bold: true},
    {id: 'InvoiceValue', col: 'D', row: 1, caption: 'Invoice Value', alignment: 'right', field: '', bold: true},
    {id: 'TaxRate', col: 'E', row: 1, caption: 'Tax Rate (%)', alignment: 'center', field: '', bold: true},
    {id: 'TaxableValue', col: 'F', row: 1, caption: 'Taxable Value', alignment: 'right', field: '', bold: true},
    {id: 'Tax', col: 'G', row: 1, caption: 'Tax', alignment: 'right', field: '', bold: true},
    {id: 'PlaceOfSupply', col: 'H', row: 1, caption: 'Place Of Supply', alignment: '', field: '', bold: true},
    {id: 'I_GST', col: 'I', row: 1, caption: 'I_GST', alignment: 'right', field: '', bold: true},
    {id: 'C_GST', col: 'J', row: 1, caption: 'C_GST', alignment: 'right', field: '', bold: true},
    {id: 'S_GST', col: 'K', row: 1, caption: 'S_GST', alignment: 'right', field: '', bold: true},
    {id: 'DocType', col: 'L', row: 1, caption: 'Doc Type', alignment: 'center', field: '', bold: true},
  ];
  ...
  const columns = [
    ...
    {id: 'Organisation', col: 'C', title: '', alignment: 'left', field: 'Organisation'},
    {id: 'InvoiceValue', col: 'D', title: '', alignment: 'right', field: 'TotalInvoiceAmt', printIfZero: true, numformat: '#,##0'},
    {id: 'TaxRate', col: 'E', title: '', alignment: 'center', field: 'TaxPercentage', printIfZero: true, numformat: '#,##0'},
    {id: 'TaxableValue', col: 'F', title: '', alignment: 'right', field: 'TaxableAmt', printIfZero: true, numformat: '#,##0'},
    {id: 'Tax', col: 'G', title: '', alignment: 'right', field: 'TaxAmt', printIfZero: true, numformat: '#,##0'},
    {id: 'PlaceOfSupply', col: 'H', title: '', alignment: '', field: 'PlaceOfSupply'},
    {id: 'I_GST', col: 'I', title: '', alignment: 'right', field: 'I_GST', printIfZero: true, numformat: '#,##0'},
    {id: 'C_GST', col: 'J', title: '', alignment: 'right', field: 'C_GST', printIfZero: true, numformat: '#,##0'},
    {id: 'S_GST', col: 'K', title: '', alignment: 'right', field: 'S_GST', printIfZero: true, numformat: '#,##0'},
    {id: 'DocType', col: 'L', title: '', alignment: 'center', field: 'GstDocType'},
  ];
  ...
  const cellsForTotals = ['D','F','G','I','J','K'];
