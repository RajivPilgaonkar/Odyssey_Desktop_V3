...
<p style={{display: 'inline-block'}}><strong>Service City: </strong> 
  The unique cities in which for the selected agent, a cost is entered.
  This is the first city in the city group. If the toggle is moved to the 
  right, then all the cities are displayed. This option can be used to 
  enter a cost for the selected agent, in a new city. 
</p><br></br>
...
<p style={{display: 'inline-block'}}><strong>Adding a new cost: </strong> 
  ...
  drop down), then you can set that as well. Click on the 
...
<p style={{display: 'inline-block'}}><strong>Copying Data: </strong> 
  ...
  by clicking on the 'copy' icon on the 'Car (City Groups) 'header. This 
