...
import { getDevExtremeTable, getDevExtremePopupForm, tableHeaderArray } from "./GetAccAgentGstData";
...
function CostAccAgentGst(props) {
  ...
  useEffect (() => {
    ...
    compVar = {
      ...
      mainTitle: 'Agent Gst', title: 'New Agent Gst',
...
export default CostAccAgentGst;
