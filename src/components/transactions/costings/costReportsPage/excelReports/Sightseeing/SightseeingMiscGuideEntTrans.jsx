...
export async function exportSightseeingMiscGuideEntTrans(reportObj, priceData, worksheet, worksheetName, worksheetIndex) {
  ...
  const columns = [
    ...
    {id: 'servicecity', col: 'B', title: 'Service City', width: 12, alignment: '', field: ''},
    {id: 'service', col: 'C', title: 'Service', width: 21, alignment: '', field: ''},
    {id: 'agent', col: 'D', title: 'Default Agent', width: 21, alignment: '', field: ''},
    {id: 'remarks', col: 'E', title: 'Remarks', width: 17, alignment: '', field: 'remarks', worksheets: '0,1,2'},
    {id: 'resident', col: 'F', title: 'Resident', width: 15, alignment: '', field: 'Resident', worksheets: '0,1,2'},
    {id: 'type', col: 'G', title: 'Type', width: 11, alignment: '', field: 'MiscType', worksheets: '0,1,2'},
    {id: 'vehicle', col: 'H', title: 'Vehicle', width: 17, alignment: '', field: 'Vehicle', worksheets: '3'},

    {id: 'wef', col: 'I', title: 'Wef', width: 11, dateformat: 'DD/MM/YYYY', alignment: 'center', field: 'Wef'},
    {id: 'wet', col: 'J', title: 'Wet', width: 11, dateformat: 'DD/MM/YYYY', alignment: 'center', field: 'Wet'},

    {id: 'frompax', col: 'K', title: 'From Pax', width: 11, numformat: '#,##0', alignment: 'center', field: 'FromPax'},
    {id: 'topax', col: 'L', title: 'To Pax', width: 11, numformat: '#,##0', alignment: 'center', field: 'ToPax'},
