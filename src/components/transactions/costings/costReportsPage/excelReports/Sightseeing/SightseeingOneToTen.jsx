...
//**********************************************************/
export async function exportSightseeingOneToTen(reportObj, priceData, worksheet) {
  ...
  const columns = [
    ...
    {id: 'b3', col: 'I', title: '', width: 3, alignment: '', field: ''},

    {id: 'n1', col: 'J', toCol: 'S', title: 'Cost Per Pax (in INR)', subtitle: '1', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_1', comment: 'Comment_1'},
    {id: 'n2', col: 'K', title: '', subtitle: '2', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_2', comment: 'Comment_2'},
    {id: 'n3', col: 'L', title: '', subtitle: '3', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_3', comment: 'Comment_3'},
    {id: 'n4', col: 'M', title: '', subtitle: '4', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_4', comment: 'Comment_4'},
    {id: 'n5', col: 'N', title: '', subtitle: '5', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_5', comment: 'Comment_5'},
    {id: 'n6', col: 'O', title: '', subtitle: '6', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_6', comment: 'Comment_6'},
    {id: 'n7', col: 'P', title: '', subtitle: '7', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_7', comment: 'Comment_7'},
    {id: 'n8', col: 'Q', title: '', subtitle: '8', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_8', comment: 'Comment_8'},
    {id: 'n9', col: 'R', title: '', subtitle: '9', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_9', comment: 'Comment_9'},
    {id: 'n10', col: 'S', title: '', subtitle: '10', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_10', comment: 'Comment_10'},
  ...
  for (var j=0; j<pData.length; j++) {
    ...
    for (i=0; i<columns.length; i++) {
      ...
      if (show) {
        ...
        if ((columns[i].comment !== undefined) && (pData[j][columns[i].comment] !== null)) {
