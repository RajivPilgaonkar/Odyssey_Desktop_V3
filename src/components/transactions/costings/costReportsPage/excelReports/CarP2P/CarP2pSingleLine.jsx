...
//**********************************************************/
export async function exportCarP2pSingleLine(reportObj, priceData, worksheet) {
  ...
  for (var j=0; j<pData.length; j++) {
    ...
    const sql_where = 
      ...
      'AND t.FromCities_id = ' + pData[j].FromCities_id.toString() + ' ' +
      'AND t.ToCities_id = ' + pData[j].ToCities_id.toString();
