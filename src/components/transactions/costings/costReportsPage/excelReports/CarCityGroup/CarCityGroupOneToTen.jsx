...
//**********************************************************/
export async function exportCarCityGroupOneToTen(reportObj, priceData, worksheet) {
  ...
  const columns = [
    ...
    {id: 'sector', col: 'B', title: 'Sector', width: 14, alignment: '', field: ''},
    ...
    {id: 'n1', col: 'L', toCol: 'U', title: 'Cost Per Pax', subtitle: '1', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_1'},
    {id: 'n2', col: 'M', title: '', subtitle: '2', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_2'},
    {id: 'n3', col: 'N', title: '', subtitle: '3', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_3'},
    {id: 'n4', col: 'O', title: '', subtitle: '4', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_4'},
    {id: 'n5', col: 'P', title: '', subtitle: '5', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_5'},
    {id: 'n6', col: 'Q', title: '', subtitle: '6', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_6'},
    {id: 'n7', col: 'R', title: '', subtitle: '7', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_7'},
    {id: 'n8', col: 'S', title: '', subtitle: '8', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_8'},
    {id: 'n9', col: 'T', title: '', subtitle: '9', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_9'},
    {id: 'n10', col: 'U', title: '', subtitle: '10', width: 9, numformat: '#,##0', alignment: 'right', field: 'Cost_10'},
  ...
  for (var j=0; j<pData.length; j++) {
    ...
    // new agent
    if ((pData[j].Agents_id !== prevAgents_id) || (pData[j].prevCarHireGroups_id !== prevCarHireGroups_id)) {
