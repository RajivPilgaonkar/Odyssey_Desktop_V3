...
<p style={{display: 'inline-block'}}><strong>From Pax / To Pax: </strong> 
  In the add mode, when a vehicle is selected, the 'From Pax' and 'To Pax'
  are filled in from the entries in the Masters / Car / Car Hire 
</p><br></br>
...
<p style={{display: 'inline-block'}}><strong>Copying Data: </strong> 
  ...
  by clicking on the 'copy' icon on the 'Car (Per Km) 'header. This 
