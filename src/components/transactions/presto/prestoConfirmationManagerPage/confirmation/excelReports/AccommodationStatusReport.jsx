...
//**********************************************************/
export async function exportAccommodationStatusReport (reportObj, worksheet) {
  ...
  const columnWidths = [{col: 'A', colIndex: 0, width: 12}, {col: 'B', colIndex: 1, width: 26},
    ...
    {col: 'I', colIndex: 8, width: 74}, {col: 'J', colIndex: 9, width: 26}, {col: 'K', colIndex: 10, width: 13}, 
    {col: 'L', colIndex: 11, width: 13}
  ];
...
async function moduleDetails(reportObj, worksheet) {
  ...
  const fields = [
    ...
    {id: 'description', col: 'I', row: 1, caption: 'Description', alignment: '', field: '', bold: true, extra: true},
    {id: 'remarks', col: 'J', row: 1, caption: 'Remarks', alignment: '', field: '', bold: true, extra: true},
    {id: 'reqOn', col: 'K', row: 1, caption: 'Req. On', alignment: 'center', field: '', bold: true, extra: true},
    {id: 'reqBy', col: 'L', row: 1, caption: 'Req. By', alignment: 'center', field: '', bold: true, extra: true},
  ];
  ...
  const columns = [
    ...
    {id: 'servicestring', col: 'I', title: '', alignment: '', field: 'ServiceString', extra: false},
    {id: 'remarks', col: 'J', title: '', alignment: '', field: 'Remarks', extra: false},

    {id: 'reqOn', col: 'K', title: '', alignment: 'center', field: 'RequestedOn', dateformat: 'DD/MM/YYYY', extra: false},
    {id: 'reqBy', col: 'L', title: '', alignment: 'center', field: 'RequestedBy', extra: false}
  ...
  cell.value = 'Accommodation Status as on ' + reportObj.asOf;  
  ...
  // set Lower Border
  cellsForBorder = ['A','B','C','D','E','F','G','H','I','J','K','L'];
