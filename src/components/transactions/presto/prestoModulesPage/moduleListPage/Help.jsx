...
<div style={{fontFamily: 'Lato', fontSize: 20, background: '#f5f5f0'}}>
  ...
  <p style={{display: 'inline-block'}}><strong>Data Colour Coding: </strong> 
    ...
    be further modified. However, a cancelled tour can be invoiced, 
    due to cancellation charges, and would turn green once invoiced
    but with a strikethrough to indicate cancelleation <br></br>
    Black would mean that the tour has not been invoiced. This module
    quotation can be modified <br></br>
    <br></br>
  </p><br></br>
  ...
  <p style={{display: 'inline-block'}}><strong>Module Quotation Cancellation: </strong> 
    ...
    yet<br></br>
    The cancellation percentages are set in Masters / General / Agent Cancellation
    <br></br>
    For cancelled modules, the cancellation percentage and invoice amount
    columns will appear in the line items. Where is the cancellation percentage 
    is non-zero, the invoice amount is computed for the line item. If the 
    cancellation percentage is 0, it is assumed that the corresponding line
    item will be charged in full. If for some reason you do not want to 
    charge an item, you can either delete that line item or you could set 
    the Qty to 0.
    <br></br>
  </p><br></br>
  ...
  <p style={{display: 'inline-block'}}><strong>Editing Module Quotations: </strong> 
    ...
    To check the line items associated with this quotation, click on 
    the 'Line Items' button in the top panel. Similarly, you can view
    the form by clicking on the 'Form' button.<br></br>
    <br></br>
    ...
    the item and selecting the desired group or through the button 
    'Actions for the period'. Non-classified items can also 
  ...
  <p style={{display: 'inline-block'}}><strong>Working Backwards from 'Tax After Amt': </strong> 
    Enter the 'Amt After Tax'. Click on the button to the right of the 
    entry field where the hint displays 'Work Backwards from Amt after 
    Tax'. This will set the rate Rate such that the
  ...
  <p style={{display: 'inline-block'}}><strong>Invoiced Modules: </strong> 
    Invoiced Modules cannot be edited or deleted. A cancelled module, however, 
    can be edited as long as it is not invoiced.<br></br>
  </p><br></br>
</div>
