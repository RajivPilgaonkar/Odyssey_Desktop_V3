...
import { saveEditedInsertedData, checkNullErrors, getFieldsArray, setDateTimeFormat } from "../../../common/CommonTransactionFunctions";
import { getDevExtremeTable, getDevExtremePopupForm, tableHeaderArray } from "./GetPrestoCompositeReportData";
...
import './PrestoComposite.css'

let compVar = {};

function PrestoCompositeReportForm(props) {
  ...
  useEffect (() => {
    ...
    compVar = {
      ...
      tableName: 'QuoPrint', keyField: 'QuoPrint_id',
      masterDescField: '',
      formData: [], formOldData: [], formMode: -1, formTitle: 'ABC',
      mainTitle: 'Itinerary Form', title: 'New Form',
  ...
  const filterData = async() => {
    ...
    try {
      ...
      const tableStr = "QuoPrint qp";  
      compVar.mainData =  await dbGetRecord({fields: fieldArray, orders: ['qp.QuoPrint_id'], table: tableStr, where: whereStr, x_uid: _g_users_id, x_module: 'Presto Change Pax'});   
  ...
  const renderContent = () => {
    ...
    return (
      <>
        <div className="master-grid-container composite-report-form" style={{height: containerHeight-80}}>
...
export default PrestoCompositeReportForm;
