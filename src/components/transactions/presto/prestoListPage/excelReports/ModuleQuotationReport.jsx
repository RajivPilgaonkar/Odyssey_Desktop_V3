...
async function moduleHeader(headerData, worksheet) {
  ...
  const rowHeights = [{row: 2, height: 63}, {row: 6, height: 79}];

  // Print all Header fields
  printHeaderFields(fields, headerData, worksheet);
...
async function modulePaxNames(paxData, worksheet) {
  ...
  // Print all Header fields
  printHeaderFields(fields, paxData, worksheet);
...
async function moduleDetails(detailsData, worksheet) {
  ...
  // Print all Header fields
  printHeaderFields(fieldArr, detailsData, worksheet);
